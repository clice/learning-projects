# 🧮 Mini Calculadora — Python POO

Projeto usando POO para treinar lógica, funções, entrada de dados, organização de código, classes e métodos.
...
python3 poo_calculator.py        # Executar o projeto
